function local_field_gen_7T(output_dir)
%Michael Germuska 
%Eleonora Patitucci
...
if exist(fullfile(output_dir, 'mask_adj_mask.nii.gz'), 'file') ~= 2
    disp('create mask');
    ...
    mask_data=load_untouch_nii(fullfile(output_dir, 'mask_adj_mask.nii.gz'));
